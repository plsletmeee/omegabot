...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(interaction.options.getSubcommandGroup() == 'set' && interaction.options.getSubcommand() == 'level') {
            ...
            if(amount < 0) return interaction.reply({content: `<:cross:1062133327370399884> Cannot set level to ${amount}! Minimum is 0.`, ephemeral: true})
            ...
            Schema.findOne({ Guild : interaction.guild.id, ID : member.id }, async (err, data) => {
                ...
                if(!data) {
                    ...
                    interaction.reply({content: `<:check:1062133324329517138> Set ${member.user.username}'s level to ${amount}.`, ephemeral: true})
        ...
        if(interaction.options.getSubcommandGroup() == 'add' && interaction.options.getSubcommand() == 'xp') {
            ...
            if(amount < 0) return interaction.reply({content: `<:cross:1062133327370399884> Cannot add ${amount} XP! Minimum is 0.`, ephemeral: true})
            ...
            Schema.findOne({ Guild : interaction.guild.id, ID : member.id }, async (err, data) => {
                ...
                if(!data) {
                    ...
                    interaction.reply({content: `<:check:1062133324329517138> Added ${amount} XP to ${member.user.username}.`, ephemeral: true})
        ...
        if(interaction.options.getSubcommandGroup() == 'add' && interaction.options.getSubcommand() == 'level') {
            ...
            if(amount < 0) return interaction.reply({content: `<:cross:1062133327370399884> Cannot add ${amount} levels! Minimum is 0.`, ephemeral: true})
            ...
            Schema.findOne({ Guild : interaction.guild.id, ID : member.id }, async (err, data) => {
                ...
                if(!data) {
                    ...
                    interaction.reply({content: `<:check:1062133324329517138> Added ${amount} levels to ${member.user.username}.`, ephemeral: true})
