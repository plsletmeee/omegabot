...
module.exports = {
    ...
    async execute(client) {
        ...
        console.log(`[MAIN] Login Successful. ${client.user.username} Online.`);
        ...
        setInterval(() => {
            ...
            client.guilds.cache.forEach((guild) => {
                ...
                const DailyMessagesSchema = require('../../../database/bot/daily-messages');
        ...
        client.guilds.cache.forEach((guild) => {
            ...
            const RoleCounterSchema = require('../../../database/bot/rolecounter');
            ...
            const MemberCounterSchema = require('../../../database/bot/membercounter');
            ...
            const BotCounterSchema = require('../../../database/bot/botcounter');
            ...
            const OnlineCounterSchema = require('../../../database/bot/onlinecounter');
